  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-12">
      ...
      <p className="text-lg text-gray-600 text-justify leading-loose mb-8">
        I am an enthusiastic IT professional with a strong passion for technology&hellip;
      </p>
      ...
      <p className="text-lg text-gray-600 text-justify leading-loose">
        Technology has always been my passion. I am excited about the endless possibilities that IT offers&hellip;
      </p>
    </section>
  );
}
