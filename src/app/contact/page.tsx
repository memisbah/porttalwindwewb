  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <p className="text-lg text-gray-600 text-center mb-8">
        If you have any questions or want to collaborate, feel free to reach out&hellip;
      </p>
      ...
      <p className="text-lg text-gray-600 text-center mb-8">
        Outside of coding, I enjoy exploring new design trends&hellip;
      </p>

      <h3 className="text-2xl text-blue-600 mb-4">Future Goals</h3>
      <p className="text-lg text-gray-600 text-center">
        In the near future, I hope to expand my knowledge in full-stack development&hellip;
      </p>
    </div>
  );
}
